...
},{"./components/_burger":"aATkn","./components/_slider":"303C2","./components/_canvas":"jopGw","./components/_showMenu":"8Y8nq","./components/_themeSwitch":"dvDYb"}],"aATkn":[function(require,module,exports) {
...
const swiperTeam = new (0, _swiperDefault.default)(".slider-list", {
    slidesPerView: 1,
    modules: [
...
class Particle {
    ...
    update() {
        if (this.position.x > window.innerWidth || this.position.x < 0) this.speed.x *= -1;
        if (this.position.y > window.innerHeight || this.position.y < 0) this.speed.y *= -1;
...
const subMenu = document.querySelectorAll(".nav__list>li>a");
